...
const LoginF = () => {
  ...
  const handleSubmit= (e) =>{
    ...
    axios.post('http://localhost:3001/auth//login/student',{email,password})
    .then(Response=>{
      ...
      if(Response.data.status)
        ...
        if (Response.data.message=="Student is not registered") {
  ...
  return (
    ...
    <div className="dark-background">
      <div className="register-container">
        ...
        <h2 className="s">Login (Student)</h2>
        ...
        <form onSubmit={handleSubmit}>
         ...
         <p ><Link to='/regst' id='linkbro'>Sign Up</Link></p>
      </div>
    </div>
    </>
  );

...
const RegisterS = () => {
  ...
  const handleSubmit= (e) =>{
    ...
    axios.post('http://localhost:3001/auth/signup',{linkid,name,email,password})
    .then(Response=>{
    ...
    <div className="dark-background">
      <div className="register-container">
        ...
        <div className="form-group">
            ...
            <input type='number' class="input" autoComplete='off' name="Link id" placeholder='Link id' onChange={(e)=>setlinkid(e.target.value)} className="input-field"/>
            
          </div>

          <div className="form-group">
            <label className="form-label">Username</label>
            <input type='text' class="input" autoComplete='off' name="name" placeholder='Name' onChange={(e)=>setName(e.target.value)} className="input-field"/>

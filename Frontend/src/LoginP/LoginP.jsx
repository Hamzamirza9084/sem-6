...
const LoginF = () => {
  ...
  const handleSubmit= (e) =>{
    ...
    axios.post('http://localhost:3001/auth//login/principal',{email,password})
    .then(Response=>{
      ...
      if(Response.data.status)
        ...
        if (Response.data.message=="Principal is not registered") {
          toast.error("Principal is not registered", {
            position: "top-center",
            autoClose: 2000,
            hideProgressBar: false,
            closeOnClick: true,
  ...
  return (
    ...
    <div className="dark-background">
      <div className="register-container">
        ...
        <h2 className="s">Login (Principal)</h2>
